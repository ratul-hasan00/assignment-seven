...
const Footer = () => {
    return (
        <div className='bg-black mt-10'>
            <div className='flex justify-between max-w-[1250px] mx-auto py-10 border-b-1 border-gray-900'>
            <div>
                <h1 className='text-white text-2xl font-semibold'>CS — Ticket System</h1>
                <p className='text-[#a1a1aa] text-sm w-[260px] mt-2'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
            </div>
            <div>
                <h1 className='text-white text-2xl font-semibold'>Company</h1>
                <ul className='text-[#a1a1aa] text-sm space-y-3 mt-2'>
                    <li>About Us</li>
                    <li>Our Mission</li>
                    <li>Contact Saled</li>
                </ul>
            ...
            <div>
                <h1 className='text-white text-2xl font-semibold'>Social Links</h1>
        ...
        <div>
            <p className='text-white text-xs text-center py-5'>© 2025 CS — Ticket System. All rights reserved.</p>
        </div>
        </div>
